namespace Services.Models
{
    public class SFU : Message
    {
		...
		public decimal DayLow { get; set; }				// highestPrice

		public decimal DayHigh { get; set; }			// lowestPrice

		public decimal MatchPrice { get; set; }			// matchPrice

		public decimal MatchQuantity { get; set; }		// matchQuantity

        public long ForeignBuyQuantity { get; set; }	// buyForeignQtty

        public long ForeignSellQuantity { get; set; }	// sellForeignQtty

		public decimal AccumulatedValue { get; set; }	// accumulatedVal

		public long AccumulatedVolume { get; set; }		// accumulatedVol
    }
}